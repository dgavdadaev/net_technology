...
#
# Скрипт исследует влияние коэффициента заразности β на динамику
# распространения инфекции. Для каждого значения β выполняется несколько
# независимых прогонов модели, после чего вычисляются усреднённые показатели.
#
...
for params in params_list
    ...
    println(
        "Завершён эксперимент с beta = $(params[:beta]), seed = $(params[:seed])",
    )
end
